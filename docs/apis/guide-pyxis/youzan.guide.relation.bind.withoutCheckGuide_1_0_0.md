---
apiName: "youzan.guide.relation.bind.withoutCheckGuide.1.0.0"
version: "1.0.0"
appName: "guide-pyxis"
apiGroup: "其它"
...
```bash
curl -X POST 'https://open.youzanyun.com/api/youzan.guide.relation.bind.withoutCheckGuide/1.0.0' \
...
```python
import requests
url = "https://open.youzanyun.com/api/youzan.guide.relation.bind.withoutCheckGuide/1.0.0"
payload = {}
...
*原文地址：[doc.youzanyun.com](https://doc.youzanyun.com/detail/content/API/0/4396)*
---
apiName: "youzan.cloud.security.query.namecode.1.0.1"
version: "1.0.1"
...
```bash
curl -X POST 'https://open.youzanyun.com/api/youzan.cloud.security.query.namecode/1.0.1' \
...
```python
import requests
url = "https://open.youzanyun.com/api/youzan.cloud.security.query.namecode/1.0.1"
payload = {}
...
*原文地址：[doc.youzanyun.com](https://doc.youzanyun.com/detail/content/API/0/4725)*
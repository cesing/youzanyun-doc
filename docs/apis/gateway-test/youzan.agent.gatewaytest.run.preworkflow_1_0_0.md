...
deprecated: false
since: "2025-05-22"
detailUrl: "https://doc.youzanyun.com/detail/content/API/0/4816"
---
...
| `code` | `integer` | ❌ | `200` | test |
| `data` | `object` | ❌ | `` | test |
| `message` | `string` | ❌ | `message` | test |
| `statusCode` | `string` | ❌ | `statusCode` | test |
| `success` | `integer` | ❌ | `true` | test |
---
## 4. cURL / Python 调用示例
```bash
curl -X POST 'https://open.youzanyun.com/api/youzan.agent.gatewaytest.run.preworkflow/1.0.0' \

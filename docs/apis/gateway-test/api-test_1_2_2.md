...
deprecated: false
since: "2021-09-24"
detailUrl: "https://gateway.qima-inc.com/api-manager/detail?id=3269"
---
# api-test.1.2.2
...
## 2. 请求
**请求方法**: `POST`
**请求地址**: `https://open.youzanyun.com/api/api-test/1.2.2`
**超时时间**: `5000ms`
**鉴权方式**: `需要Token`
**请求参数 Schema**（4 个参数）:
```json
...
# 文档地址: https://gateway.qima-inc.com/api-manager/detail?id=3269

curl -X POST 'https://open.youzanyun.com/api/youzan.skinfo/1.2.2' \
...
url = "https://open.youzanyun.com/api/api-test/1.2.2"
headers = {
...
*（暂无关联数据，文档完善后将补充相关接口）*
---
_本文档由 AI 自动生成，源数据来自 [有赞云开放平台详情页](https://gateway.qima-inc.com/api-manager/detail?id=3269)_
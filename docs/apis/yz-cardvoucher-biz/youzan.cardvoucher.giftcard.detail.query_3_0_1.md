---
apiName: "youzan.cardvoucher.giftcard.detail.query.3.0.1"
version: "3.0.1"
status: "待上线"
...
deprecated: false
since: "2019-08-30"
detailUrl: "https://gateway.qima-inc.com/api-manager/detail?id=606"
---
# youzan.cardvoucher.giftcard.detail.query.3.0.1
...
## 2. 请求
**请求方法**: `POST`
**请求地址**: `https://open.youzanyun.com/api/youzan.cardvoucher.giftcard.detail.query/3.0.1`
**超时时间**: `5000ms`
**鉴权方式**: `需要Token`
**请求参数 Schema**（5 个参数）:
```json
{
  ...
  "properties": {
    ...
    "update_time_before": {
      "type": "string",
      "description": "更新时间范围from，格式：2019-07-01 00:00:00（保证update_time_after>=update_time_before）",
      "example": "2019-07-01 00:00:00"
    },
    "update_time_after": {
      "type": "string",
      "description": "更新时间范围to，，格式：2019-08-01 00:00:00（保证update_time_before<=update_time_after）",
...
| `update_time_before` | `string` | ❌ 否 | `2019-07-01 00:00:00` | 更新时间范围from，格式：2019-07-01 00:00:00（保证update_time_after>=updat |
| `update_time_after` | `string` | ❌ 否 | `2019-08-01 00:00:00` | 更新时间范围to，，格式：2019-08-01 00:00:00（保证update_time_before<=updat |
| `page` | `string` | ✅ 是 | `1` | 页码，从1开始正整数。如果记录较多请使用时间参数分割 |
| `page_size` | `string` | ✅ 是 | `10` | 每页条数。默认20条，最大不能超过50，建议使用默认分页。如果记录较多请使用时间参数分割 |
---
## 3. 响应
**响应参数 Schema**（11 个字段）:
```json
...
| `principal_dnom` | `string` | ❌ 否 | `300` | 本金余额，单位：分 |
---
## 4. cURL / Python 调用示例
```bash
# 有赞云 API 调用示例
# 有赞云地址: https://open.youzanyun.com
# 文档地址: https://gateway.qima-inc.com/api-manager/detail?id=606
...
url = "https://open.youzanyun.com/api/youzan.cardvoucher.giftcard.detail.query/3.0.1"
headers = {
...
*（暂无关联数据，文档完善后将补充相关接口）*
---
_本文档由 AI 自动生成，源数据来自 [有赞云开放平台详情页](https://gateway.qima-inc.com/api-manager/detail?id=606)_
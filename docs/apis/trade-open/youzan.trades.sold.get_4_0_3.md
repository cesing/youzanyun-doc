---
apiName: "youzan.trades.sold.get.4.0.3"
version: "4.0.3"
appName: "trade-open"
apiGroup: "交易订单"
authType: "凭证式"
detailUrl: "https://doc.youzanyun.com/detail/content/API/0/3758"
---

# youzan.trades.sold.get.4.0.3
...
**请求地址**: `https://open.youzanyun.com/api/youzan.trades.sold.get/4.0.3`
...
```bash
curl -X POST 'https://open.youzanyun.com/api/youzan.trades.sold.get/4.0.3' \
...
```python
import requests
url = "https://open.youzanyun.com/api/youzan.trades.sold.get/4.0.3"
payload = {}
...
*原文地址：[doc.youzanyun.com](https://doc.youzanyun.com/detail/content/API/0/3758)*